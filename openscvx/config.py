...
class SimConfig:
    ...
    def __init__(
        ...
        constraints_nodal_cross_node: Optional[list[Callable]] = None,
        constraints_nodal_cross_node_convex: Optional[list[Callable]] = None,
        ...
        Args:
            ...
            constraints_nodal_cross_node (list, optional): List of non-convex nodal cross-node
                constraints.
            constraints_nodal_cross_node_convex (list, optional): List of convex nodal cross-node
                constraints.
        ...
        self.constraints_nodal_cross_node = (
            constraints_nodal_cross_node if constraints_nodal_cross_node is not None else []
        )
        self.constraints_nodal_cross_node_convex = (
            constraints_nodal_cross_node_convex
            if constraints_nodal_cross_node_convex is not None
            else []
        )
