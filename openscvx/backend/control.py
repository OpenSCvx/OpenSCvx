...
class Control(Variable):
    ...
    both true and augmented control dimensions. It provides methods for appending new
    control variables and accessing subsets of the control vector.
    ...
    Attributes:
        ...
        guess (np.ndarray): Used to initialize SCP and contains the current SCP solution for
            the control trajectory. Shape: (n_nodes, n_controls).
